...
class StableVoiceWorker(QThread):
    """稳定语音识别线程"""
    ...
    def run(self):
        ...
        try:
            ...
            self.voice_system = FunASRVoiceSystem(
                recognition_duration=30,  # 减次识别30秒
            ...
            try:
                ...
                self.log_message.emit(f"⚠️ 键盘监听启动失败: {e}")
...
class StableMainWindow(QMainWindow):
    ...
    def init_ui(self):
        """初始化界面"""
        self.setWindowTitle("FunASR语音识别系统 v2.3 (稳定版)")
...
def main():
    ...
    app.setApplicationName("FunASR语音识别系统 (稳定版)")
